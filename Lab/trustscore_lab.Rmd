...
```{python}
# Creates graphs about how correct the prediction is for the wine dataset via logistic regression
...
datasets = [(X_penguins, y_penguins)]
dataset_names = ["Penguins"]
...
Try another model from the trustscore_evaluation.py file, like LinearSVC or RandomForestClassifier rather LogisticRegression.
